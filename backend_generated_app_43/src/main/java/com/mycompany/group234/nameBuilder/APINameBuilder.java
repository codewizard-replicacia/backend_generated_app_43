...
public class APINameBuilder implements JPAEdmNameBuilder {
	...
	public String buildEntitySetName(final String entityTypeName) {
    	...
    	eSetName = "OrderAlert".equals(entityTypeName) ? "OrderAlerts" : defaultNameBuilder.buildEntitySetName(entityTypeName);
    	eSetName = "Restuarant".equals(entityTypeName) ? "Restuarants" : defaultNameBuilder.buildEntitySetName(entityTypeName);
    	...
    	eSetName = "Inventory".equals(entityTypeName) ? "Inventories" : defaultNameBuilder.buildEntitySetName(entityTypeName);
        return eSetName;
    }
